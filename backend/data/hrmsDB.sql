...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2022 at 05:38 PM
...
(7001, 1006, '2021-03-18', 'M', 'NULL', 15000.00, 1001),
(7002, 1007, '2022-05-18', 'M', 'NULL', 9000.00, 1001),
(7003, 1008, '2022-05-22', 'M', 'NULL', 2500.00, 1001),
...
(7008, 1013, '2021-10-08', 'I', 'NULL', 1250.00, 1001),
...
(4002, NULL, 1004, 'P', 'A', '2022-11-25'),
(4003, NULL, 1006, 'I', 'F', '2022-01-09'),
(4004, NULL, 1007, 'P', 'F', '2021-06-18'),
(4005, NULL, 1011, 'P', 'A', '2022-05-20'),
(4006, NULL, 1015, 'P', 'C', '2021-07-30'),
(4007, NULL, 1018, 'P', 'A', '2022-08-24');
...
--
ALTER TABLE `ot`
  MODIFY `OT_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8001;
